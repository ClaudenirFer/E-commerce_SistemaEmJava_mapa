 ...
 */
@Entity
@Table(name = "`tb_vendedor`", catalog = "`e-commerce`", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Vendedor implements Serializable {
    ...
    public Vendedor(String nome, Date datanascimento, String rua, String numero, String complemento, String bairro, String cidade, String estado, String cpf, String rg, String email, String nomeusuario, String senhahash) {
    ...
    public String toString() {
        return "br.com.ecommmerce.models.Vendedor[ id=" + id + " ]";
    }
